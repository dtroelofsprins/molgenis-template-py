...
Welcome to ``molgenis-template-py`` contributor's guide.
...
If you experience bugs or general issues with ``molgenis-template-py``, please have a look
...
You can help improve ``molgenis-template-py`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``molgenis-template-py`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``molgenis-template-py``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n molgenis-template-py python=3 six virtualenv pytest pytest-cov
    conda activate molgenis-template-py
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/molgenis-template-py.git
    cd molgenis-template-py
...
#. Install |pre-commit|_::
   ...
   ``molgenis-template-py`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/molgenis-template-py
.. _issue tracker: https://github.com/<USERNAME>/molgenis-template-py/issues
.. <-- end -->
